    ...
    <div class="p-6">
      <div v-if="!item && !loading" class="text-center py-12">
        ...
        <p class="text-gray-500 mb-4">
          The bakery item you're looking for doesn't exist.
        </p>
        <NuxtLink to="/bakery-items" class="btn-primary"
          >Back to Items</NuxtLink
        >
      </div>
            ...
            <div class="space-y-4">
              <div>
                ...
                <p class="text-xs text-gray-500 mt-1">
                  Use image URLs from Google Drive, Imgur, Unsplash, or any
              ...
              <div class="space-y-2">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-2">
                  ...
                  <button
                    ...
                    @click="
                      setExampleImage(
                        'https://via.placeholder.com/400x300/FFB6C1/000000?text=Bakery+Item'
                      )
                    "
                    class="text-xs text-blue-600 hover:text-blue-800 text-left"
                  >
...
const loadItem = async () => {
  // Fetch both items and types
  await Promise.all([
    bakeryStore.fetchBakeryItems(),
    bakeryTypeNames.value.length === 0
...
const submitForm = async () => {
  try {
    ...
    // Update the bakery item with converted URL
    await bakeryStore.updateBakeryItem(id, itemData);
