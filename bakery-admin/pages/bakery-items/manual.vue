<template>
  <div>
    ...
    <div class="p-6">
      ...
      <!-- Table -->
      <div v-else-if="!loading && filteredItems.length > 0" class="bg-white rounded-lg shadow overflow-hidden">
...
td:nth-child(1) { /* Row number */
  width: 60px;
  min-width: 60px;
}

td:nth-child(2) { /* Image */
  width: 80px;
  min-width: 80px;
}
...
td:nth-child(6) { /* Description */
  min-width: 200px;
  max-width: 250px;
}

td:nth-child(7) { /* Shelf Life */
  width: 100px;
  min-width: 100px;
}

td:nth-child(8) { /* Reheat Info */
  min-width: 150px;
  max-width: 180px;
}

td:nth-child(9) { /* Storage Methods */
  min-width: 150px;
  max-width: 180px;
}

td:nth-child(10) { /* Display Methods */
  min-width: 150px;
  max-width: 180px;
}

td:nth-child(11) { /* Environment */
  min-width: 140px;
  max-width: 160px;
}

td:nth-child(12) { /* Dates */
  min-width: 120px;
  max-width: 140px;
}

td:nth-child(13) { /* Actions */
  width: 80px;
  min-width: 80px;
}
