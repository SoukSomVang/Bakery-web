            ...
            <div class="max-w-lg">
              ...
              <div class="space-y-4 mb-8">
                <div class="flex items-center space-x-3">
                  ...
                  <span class="text-gray-700">{{ t('wholeBread.feature1') }}</span>
                </div>
                <div class="flex items-center space-x-3">
                  <div class="w-6 h-6 bg-red-100 rounded-full flex items-center justify-center">
                    <svg class="w-4 h-4 text-red-600" fill="currentColor" viewBox="0 0 20 20">
                  ...
                  <span class="text-gray-700">{{ t('wholeBread.feature2') }}</span>
                </div>
                <div class="flex items-center space-x-3">
                  <div class="w-6 h-6 bg-red-100 rounded-full flex items-center justify-center">
                    <svg class="w-4 h-4 text-red-600" fill="currentColor" viewBox="0 0 20 20">
                  ...
                  <span class="text-gray-700">{{ t('wholeBread.feature3') }}</span>
                </div>
                <div class="flex items-center space-x-3">
                  <div class="w-6 h-6 bg-red-100 rounded-full flex items-center justify-center">
                    <svg class="w-4 h-4 text-red-600" fill="currentColor" viewBox="0 0 20 20">
                  ...
                  <span class="text-gray-700">{{ t('wholeBread.feature4') }}</span>
                </div>
              </div>
              ...
              <div class="bg-gray-50 p-6 rounded-lg mb-8">
                ...
                <div class="grid grid-cols-2 gap-4 text-sm">
                  <div>
                    <span class="text-gray-600">{{ t('wholeBread.calories') }}</span>
                    <span class="font-semibold ml-2">80</span>
                  </div>
                  <div>
                    <span class="text-gray-600">{{ t('wholeBread.protein') }}</span>
                    <span class="font-semibold ml-2">4g</span>
                  </div>
                  <div>
                    <span class="text-gray-600">{{ t('wholeBread.fiber') }}</span>
                    <span class="font-semibold ml-2">3g</span>
                  </div>
                  <div>
                    <span class="text-gray-600">{{ t('wholeBread.wholeGrains') }}</span>
    ...
    <section class="py-16 bg-gray-50 scroll-section opacity-0 translate-y-10 transition-all duration-700">
      <div class="container mx-auto px-4">
        <div class="text-center mb-12">
          <h2 class="text-4xl font-bold text-gray-800 mb-4">{{ t('wholeBread.ourPartners') }}</h2>
        </div>
        ...
        <div class="grid sm:grid-cols-2 gap-8 max-w-4xl mx-auto">
          ...
          >
            ...
            <div class="p-6 text-center bg-gradient-to-br from-white to-gray-50">
              ...
              <div class="flex items-center justify-center text-red-600 group-hover:text-red-700 transition-colors">
                <span class="text-sm font-medium">{{ t('wholeBread.visit') }} {{ brands[0].name }}</span>
          ...
          >
            ...
            <div class="p-6 text-center bg-gradient-to-br from-white to-gray-50">
              ...
              <div class="flex items-center justify-center text-red-600 group-hover:text-red-700 transition-colors">
                <span class="text-sm font-medium">{{ t('wholeBread.visit') }} {{ brands[1].name }}</span>
                <svg class="w-4 h-4 ml-2 transform group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                </svg>
              </div>
...
useHead({
  ...
  meta: [
    ...
    {
      property: 'og:title',
      content: 'Whole Wheat Multigrain Bread - Fresh & Nutritious'
    },
    {
      property: 'og:description',
      content: 'Our signature multigrain bread combines wholesome wheat with ancient grains, seeds, and nuts. Rich in fiber, protein, and baked fresh daily.'
    }
  ]
})
</script>
